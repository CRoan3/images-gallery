...
const App = () => {
  ...
  const handleSearchSubmit = (e) => {
    ...
    fetch(
      ...
      .then((data) => {
        setImages([data, ...images]); //we put data in the beginning of the array because we want to the new data (image) to appear first. this will update array everytime an image is searched
      })
      .catch((err) => {
